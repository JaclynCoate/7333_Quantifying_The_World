...
onlineFold = subset(original_six_mac_offline, posXY %in% permuteLocs[ , 1])

offlineFold = subset(original_six_mac_offline, posXY %in% permuteLocs[ , -1])

estFold = predXY(newSignals = onlineFold[ , 9:15], 
                 newAngles = onlineFold[ , 8], 
...
estXYk5 = predXY(newSignals = onlineSummary[ , 9:15], 
                 newAngles = onlineSummary[ , 8], 
