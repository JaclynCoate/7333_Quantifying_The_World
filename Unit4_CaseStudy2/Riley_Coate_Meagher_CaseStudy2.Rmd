...
print("Variables in Main Training Data: ")
print(names(train_main))
...
lm = lm(sqrt_temp ~ O + Ca + Cu + Ba + wtd_std_ThermalConductivity,data =temp_train)
...
```{r}
 # rmse function
resid = data.frame(resid = (temp_test$sqrt_temp- predict))
...
plot(predict^2, temp_test$sqrt_temp^2)
```
