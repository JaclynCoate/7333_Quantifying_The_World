...
spamPath = "/Users/zmartygirl/githubrepos1/7333_Quantifying_The_World/Unit6_CaseStudy3"
#list.dirs(spamPath, full.names = FALSE)



list.files(path = paste(spamPath, "data", sep = .Platform$file.sep)) 



list.files(path = paste(spamPath,'spam', sep=.Platform$file.sep))

head(list.files(path = paste(spamPath, "data", "spam_2",
                             sep = .Platform$file.sep)))

dirNames = list.files(path = paste(spamPath, "data", 
                      sep = .Platform$file.sep))
length(list.files(paste(spamPath, "data", dirNames, 
                        sep = .Platform$file.sep)))

sapply(paste(spamPath, "data", dirNames, 
             sep = .Platform$file.sep), 
