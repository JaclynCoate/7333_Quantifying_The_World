...
```{r environment set up, echo=FALSE, results='markup'}
#install.packages("tm")
library(tm)
...
Probability esitmation on the Training Data
...
INSERT TEXT ON TYPE I AND TYPE II ERROR GRAPH
...
Below we are getting our tau so that one type of error is withint 1% using our 5-fold cross-validation.
