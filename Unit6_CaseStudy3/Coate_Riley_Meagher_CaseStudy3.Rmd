...
```{r }
spamPath = "C:/Users/wands/OneDrive/Desktop/spamdata"
...
```
Computer frequencies function. Computing the frequencies of spam and ham words. Exploring the frequency of both ham and spam words allows us to have more insight into our data.
